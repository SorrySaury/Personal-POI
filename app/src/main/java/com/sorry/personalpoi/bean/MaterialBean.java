...
public class MaterialBean implements Parcelable {
    ...
    private String name;
    private int type;//1.img时间   2.video 3.进入相机 4.添加图片 5.img地点
    private long fileSize;
    private long date;
    private long duration;//时长
    private String formatDuration;//标准时长
    ...
    public MaterialBean(String path, String formatDate, long id, String discr, String name, int type, long fileSize, long date, long duration, String formatDuration,double latitude, double longitude) {
        this.path = path;
