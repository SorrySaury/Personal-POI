...
import com.sorry.personalpoi.adapter.PreviewPGAdapter;
import com.sorry.personalpoi.bean.MaterialBean;
import com.sorry.personalpoi.callback.RefreshCallBack;
import com.sorry.personalpoi.util.AlbumUtils;
import com.sorry.personalpoi.view.PreviewViewPager;
import com.sorry.personalpoi.view.VideoPlayerIJK;
...
public class AlbumPreviewActivity extends Activity implements View.OnClickListener, RefreshCallBack {
    ...
    private void initView() {
        ...
        mVideoView = (VideoPlayerIJK) findViewById(R.id.preview_videoview);
