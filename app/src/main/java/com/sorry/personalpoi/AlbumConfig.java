...
public class AlbumConfig {
    //限定最大选择个数 视频+图片
    public static int ALBUM_CHECK_MAX = 999;
    //限定最大选择个数 视频
    public static int ALBUM_CHECK_VIDEO_MAX = 999;
    //限定最大可选视频大小
    public static final int VIDEO_SIZE_MAX = 300 * 1024 * 1024;
    public static final int TALBUM_REQUESTCODE = 996;
    public static final int SALBUM_REQUESTCODE = 997;
    //拆分规则 正常拆分
